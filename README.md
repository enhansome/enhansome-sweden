...
* Validate Swedish Personal Identity Number (personnummer / SSN)
  * [JavaScript](https://github.com/personnummer/js) ⭐ 59 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-10
...
* Blocket
  * [Python](https://github.com/dunderrrrrr/blocket_api) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-09-07
...
1. That it's directly related to building applications for the Swedish market (there are plenty of other awesome lists for other types of tools, [here](https://github.com/sindresorhus/awesome) ⭐ 505,673 | 🐛 106 | 📅 2026-09-02)
