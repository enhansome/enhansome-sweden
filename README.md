...
* :link: [Awesome Sweden Datasets](https://github.com/buren/awesome-sweden-datasets) ⭐ 30 | 🐛 5 | 🌐 Shell | 📅 2026-04-21
* [People](#people)
* [Companies](#companies)
* [Finance](#finance)
...
* Looking for datasets? See [Awesome Sweden Datasets](https://github.com/buren/awesome-sweden-datasets) ⭐ 30 | 🐛 5 | 🌐 Shell | 📅 2026-04-21.
...
* Validate Swedish Personal Identity Number (personnummer / SSN)
  * [JavaScript](https://github.com/personnummer/js) ⭐ 58 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-25
  ...
  * [PHP](https://github.com/personnummer/php) ⭐ 33 | 🐛 3 | 🌐 PHP | 📅 2026-08-11
  ...
  * [Python](https://github.com/personnummer/python) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2026-07-21
  * [Java](https://github.com/personnummer/java) ⭐ 9 | 🐛 5 | 🌐 Java | 📅 2026-09-24
...
* Authentication using BankID
  * [.NET (C# / F#)](https://github.com/ActiveLogin/ActiveLogin.Authentication) ⭐ 240 | 🐛 24 | 🌐 C# | 📅 2026-09-25 (With authentication handler for ASP.NET)
  * [JavaScript](https://github.com/anyfin/bankid) ⭐ 72 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 by [Anyfin](https://anyfin.com/)
...
* Blocket
  * [Python](https://github.com/dunderrrrrr/blocket_api) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-09-18
...
:information\_source: Looking to add a dataset? See [Awesome Sweden Datasets](https://github.com/buren/awesome-sweden-datasets) ⭐ 30 | 🐛 5 | 🌐 Shell | 📅 2026-04-21.

**Before you start, make sure**

1. That it's directly related to building applications for the Swedish market (there are plenty of other awesome lists for other types of tools, [here](https://github.com/sindresorhus/awesome) ⭐ 510,859 | 🐛 107 | 📅 2026-09-02)
