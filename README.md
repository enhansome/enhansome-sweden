...
* Validate Swedish Personal Identity Number (personnummer / SSN)
  * [JavaScript](https://github.com/personnummer/js) ⭐ 58 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-21
  ...
  * [Java](https://github.com/personnummer/java) ⭐ 9 | 🐛 5 | 🌐 Java | 📅 2026-09-19
...
* Validate Swedish bank accounts
  * [Ruby](https://github.com/barsoom/banktools-se) ⭐ 33 | 🐛 0 | 🌐 Ruby | 📅 2026-06-24
...
* Authentication using BankID
  * [.NET (C# / F#)](https://github.com/ActiveLogin/ActiveLogin.Authentication) ⭐ 240 | 🐛 28 | 🌐 C# | 📅 2026-08-31 (With authentication handler for ASP.NET)
...
1. That it's directly related to building applications for the Swedish market (there are plenty of other awesome lists for other types of tools, [here](https://github.com/sindresorhus/awesome) ⭐ 509,347 | 🐛 106 | 📅 2026-09-02)
